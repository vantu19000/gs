...
class HB_Menu {
	...
	public static function admin_menu() {	
		...
		add_submenu_page( 'hb_dashboard', 'Đơn đăng kí học', 'Đơn đăng kí học', 'manage_options', 'hb_dashboard', array( get_called_class(), 'dashboard' ) );
		...
		add_submenu_page( 'hb_dashboard', 'Gia sư chờ phê duyệt', 'Gia sư chờ phê duyệt', 'manage_options', 'hb_register', array( get_called_class(), 'add_register_page' ) );
