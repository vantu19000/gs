...
?>
<div class="wrap">
	<h1><?php echo __('Owner','hbpro')?> <a href="<?php echo admin_url('admin.php?page=hb_estatehost&layout=edit')?>" class="page-title-action" ><?php echo __('Add owner','hbpro')?></a></h1>
	...
	<div>
		<form>
			<table class="wp-list-table widefat fixed striped posts">
				<thead>
					<tr>
						<th><?php echo __('Name','hbpro')?></th>
						<th><?php echo __('Phone number','hbpro')?></th>
						<th>Email</th>
						<th><?php echo __('Address','hbpro')?></th>
					</tr>
				</thead>
				<tbody>
