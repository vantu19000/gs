...
?>
<div class="wrap">
	<h1><?php echo __('Estate house','hbpro')?><a href="<?php echo admin_url('admin.php?page=hb_estate&layout=edit')?>" class="page-title-action" ><?php echo __('Add new','hbpro')?></a></h1>
